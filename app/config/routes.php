...
Router::add('edit', '/edit', '\App\Controllers\Admin\EditPizzaController', 'edit');
Router::add('add', '/add', '\App\Controllers\Admin\AddPizzaController', 'add');

//ADMIN
Router::add('admin_orders', '/admin/orders', '\App\Controllers\Admin\OrdersController');
Router::add('admin_users', '/admin/users', '\App\Controllers\Admin\UsersRoleController');
